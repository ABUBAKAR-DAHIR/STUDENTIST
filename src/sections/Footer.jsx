...
export default function Footer() {
  return (
    <section className='mt-10 pt-10 container mx-auto'>
        <div className='relative py-8 pb-20 overflow-clip pt-10 px-40 max-lg:px-10 g7 lg:g6 border-2 border-s7 rounded-4xl mx-auto flex lg:min-h-[300px] max-lg:flex-col '>
            <div>
