      ...
      <Element name='header' className={clsx('fixed top-0 left-0 right-0 z-50 transition-all transform-content duration-500 ease-in-out ', scrolled ? 'bg-black-100 p-4 max-md:p-4 max-md:px-10' : 'py-14 max-md:p-10')}>
        <header className='relative flex items-center justify-center'>
          <div className='relative flex justify-around items-center md:container max-md:justify-between max-md:w-full'>
            <img src="logo.png" alt="logo" width={200} className='z-50 cursor-pointer' onClick={() => window.scrollTo({top: 0, behavior: "smooth"})}/>
            {/* <p className={clsx('logo h5 z-50 mr-10', isOpen && 'pt-2')}>Studentist</p> */}
            <div className={clsx('w-[40%] max-xl:w-[50%] max-lg:w-[70%]', isOpen ? 'max-md:absolute max-md:-top-20 max-md:-left-10 max-md:-bottom-20  max-md:min-h-screen max-md:w-[2000vw] max-md:h-[2020vh] max-md:z-10 max-md:bg-s11' : 'max-md:hidden')}>
              ...
              {
                isOpen && (
                  <div className='flex fixed bottom-20 md:hidden'>
